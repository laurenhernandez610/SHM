...
class main():
    ...
    def go(self, event): 
        ...
        self.p1.set_title('Simulated Motion')
        ...
        self.p2.set_title('Wave Function Over Time')
    ...
    def init_page(self):
        ...
        fig.text(0.05, 0.8, 'Simple Harmonic Motion: Simulation Generator', fontsize = 45)
        ...
        self.dp_box = TextBox(dc_box_loc, 'Damping Constant (k)', initial=str(self.damp_cnst))
        ...
        self.button1 = Button(bbox1, "Simulate!")
